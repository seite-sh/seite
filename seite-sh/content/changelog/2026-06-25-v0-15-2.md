...
Follow-up to the [v0.15.1](/changelog/v0-15-1) fix. The docs now explain that a collection deployed to a subdomain renders its root page with the collection's **own index template** (and context), just like its index on the main domain:
