...
This affects standalone `seite serve`. `seite build`, `seite deploy`, and workspace-mode `serve` are unchanged — they continue to use the `base_url` configured in `seite.toml`.
